...
//Signal Conversion
	...
	static TEDROOMSignal C4TCManager_PObs_Mng_Ctrl__C5ObsMng_PObsMngCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C5ObsMng_PObsMngCtrl__C4TCManager_PObs_Mng_Ctrl(TEDROOMSignal signal);
