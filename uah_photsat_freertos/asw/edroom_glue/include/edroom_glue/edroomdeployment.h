...
//Signal Conversion
	...
	static TEDROOMSignal C4TCManager_PObsCtrl__C5ObsMng_PObsCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C5ObsMng_PObsCtrl__C4TCManager_PObsCtrl(TEDROOMSignal signal);
