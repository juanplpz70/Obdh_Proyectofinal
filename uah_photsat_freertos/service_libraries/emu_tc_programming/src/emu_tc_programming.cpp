...
EmuGSS_TCProgram129_1 prog_FT_0010_step0(OBT_AFTER_POWER_ON + 10,
	"FT_UAH_PHOTSAT_SERV_129_FDIR_0020, Values to Theta, and number of samples",10,30,4);
...
EmuGSS_TCProgram19_4 prog_FT_0020_step5( OBT_AFTER_POWER_ON + 40,
	"FT_UAH_PHOTSAT_SERV_129_FDIR_0020, Enable Event Action", 0x4003);

EmuGSS_TCProgram20_3_uint8 prog_FT_0020_step6(OBT_AFTER_POWER_ON + 35,
    "FT_UAH_PHOTSAT_SERV_129_FDIR_0020, Change PID 13 parameter to !=0",13,43);
